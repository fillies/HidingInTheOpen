...
from prompts import FAIR_DETECTION_SYSTEM_PROMPT, build_detection_user_prompt

# -------------------
# CONFIG
# -------------------
INPUT_FOLDER = "../data/20_distorted"   # folder of CSVs
OUTPUT_FOLDER = "annotated_results"  # where results go
N_REPEATS = 3                       # how many times to query per cell
MODEL = "gpt-4o-mini"
TEMPERATURE = 0.0                    # keep deterministic
SAVE_SAMPLE_RAW = 0                  # e.g. 25 -> store raw votes for up to 25 cells (debugging)
...
SYSTEM_MSG = FAIR_DETECTION_SYSTEM_PROMPT
