# logistic_fit_and_plots_with_spearman.py
    ...
    for filename in os.listdir(INPUT_FOLDER):
        ...
        for col in df.columns:
            ...
            try:
                ...
                print(f"   Spearman: rho={rho:.4f} ({direction}) | p={p_spearman:.4g} ({significance})")
                ...
                plt.axvline(mhud, linestyle=":", alpha=0.8, color='red',
