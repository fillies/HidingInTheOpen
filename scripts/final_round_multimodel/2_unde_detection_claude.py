...
OUTPUT_FOLDER = "reconstructed_results_claud"  # where results go
...
def reconstruct_once(text, words_modulated):
    ...
    if len(message.content) != 0:
        ...
        if '['in message.content[0].text and ']' in message.content[0].text:
            print((message.content[0].text or "").strip())
